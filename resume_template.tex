...
<BLOCK>for project in projects</BLOCK>
      \resumeProjectHeading
          {\textbf{<< project.name >>}}<BLOCK>if project.demo_url</BLOCK>{\href{<< project.demo_url >>}{<< project.demo_url | replace('https://', '') | replace('http://', '') | replace('www.', '') >>} $|$ \href{<< project.source_url >>}{<< project.source_url | replace('https://', '') | replace('http://', '') | replace('www.', '') >>}}<BLOCK>else</BLOCK>{\href{}{}}<BLOCK>endif</BLOCK>
          \resumeItemListStart
<BLOCK>for point in project.points</BLOCK>
            \resumeItem{<< point | latex_escape >>}
<BLOCK>endfor</BLOCK>
          \resumeItemListEnd
<BLOCK>endfor</BLOCK>
    \resumeSubHeadingListEnd
